...
export default {
  ...
  computed: {
    buttonStyles() {
      return 'border rounded-lg px-4 py-1 text-sm bg-white flex justify-center items-center sm:uppercase hover:bg-violet-600 hover:text-white transform duration-500 ease-in-out dark:bg-gray-700 dark:border-gray-400 dark:text-gray-300'
    },
    disabledStyle() {
      return 'border rounded-lg px-4 py-1 text-sm bg-white flex justify-center items-center sm:uppercase text-gray-300 dark:bg-gray-800 dark:border-gray-500 dark:text-gray-600'
    },
    totalPages() {
